package com.spaceroom.blog.domain.entities;
...
public class Post {
    ...
    @ManyToMany
    // Using a join table to manage many-to-many relationship between Post and Tag
    @JoinTable(
            name = "post_tags",
    ...
    // Lifecycle callback to update updatedAt timestamp
    @PreUpdate
